...
function getNewWorkbookItemInspections(item) {
	...
	for(let inspection in item) {
		...
		if(inspection === 'Visual' && item[inspection] !== 'N/A') inspectionLetter = 'V'
		else if(inspection === 'Internal' && item[inspection] !== 'N/A') inspectionLetter = 'I'
		else if(inspection === 'Leakage' && item[inspection] !== 'N/A') inspectionLetter = 'K'
		else if(inspection === 'Pressure' && item[inspection] !== 'N/A') inspectionLetter = 'P'
		else if(inspection === 'Thickness' && item[inspection] !== 'N/A') inspectionLetter = 'T'
		else if(inspection === 'Upper Coupler' && item[inspection] !== 'N/A') inspectionLetter = 'UC'
		else if(inspection === 'Wet Fluorescent' && item[inspection] !== 'N/A') inspectionLetter =  'WF'
		else if(inspection === 'Lining' && item[inspection] !== 'N/A') inspectionLetter = 'L'
		else continue
